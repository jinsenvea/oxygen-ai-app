import{_ as w,c as b,a as s,u as c,s as e,n as m,F as r,b as i,e as u,r as x,t as o,f as g,k as v,i as d}from"./index-BCvCxn0-.js";const F={class:"detail-page"},T={class:"dp-header"},D={class:"dp-body"},N={class:"main-tabs"},A={class:"baby-grid-detail"},V={class:"feed-card"},M={class:"fc-time"},R={class:"fc-duration"},S={class:"fc-amount"},z={__name:"NursingReport",setup(E){const t=g("mom"),k=g([{time:"06:30",type:"right",duration:15,amount:80},{time:"09:00",type:"left",duration:18,amount:90},{time:"11:30",type:"right",duration:12,amount:70},{time:"14:00",type:"left",duration:20,amount:100}]);function f(){window.history.back()}function C(){v({title:"🩹 伤口护理详情",message:`🟢 恢复良好
